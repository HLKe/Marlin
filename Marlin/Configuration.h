...
#define STRING_CONFIG_H_AUTHOR "(HuLK)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "HLK Volcano"         // will be shown during bootup in line 2
...
#define X_MIN_POS -2.2  // 0mm is tegen de eindstop
#define Y_MIN_POS -13 // 
#define Z_MIN_POS 0
#define X_MAX_POS 280 // 284 max gemeten
#define Y_MAX_POS 242 // 247 max travel gemeten
...
// #define DEBUG_LEVELING_FEATURE
  ...
  //#define BACK_PROBE_BED_POSITION 251
